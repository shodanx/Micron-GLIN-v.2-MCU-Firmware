/*************************************************************************
 *    File name   : Font_6x8.c
 *    Description :  Шрифт 6 на 8 пикселов.
...
const LPC_INT8U Font_6x8_Data[] =
{
  ...
  // 0x12 - полоса прокрутки верх пустая
  //0xff, 0x01, 0x01, 0xff, 0x00, 0x00,
  // 0x12 - символ "альфа"
  0x00, 0x30, 0x48, 0x50, 0x3e, 0x40,

  // 0x13 - два восклицательных знака.
  //0x00, 0x00, 0x5f, 0x00, 0x5f, 0x00,
  // 0x13 - полоса прокрутки середина пустая
  //0xff, 0x00, 0x00, 0xff, 0x00, 0x00,
  // 0x13 - символ "бета"
  0x00, 0xfe, 0x25, 0x25, 0x1a, 0x00,

  // 0x14 - символ "Пи".
  //0x00, 0x06, 0x09, 0x7f, 0x01, 0x7f,
  // 0x14 - полоса прокрутки низ пустая
  //0xff, 0x80, 0x80, 0xff, 0x00, 0x00,
  // 0x14 - символ "гамма"
  0x00, 0x22, 0x54, 0x48, 0x34, 0x02,

  // 0x15 - символ параграфа.
  //0x00, 0x22, 0x4d, 0x55, 0x59, 0x22,
  // 0x15 - полоса прокрутки заполненный верх открытый низ
  //0xff, 0x1f, 0x1f, 0xff, 0x00, 0x00,
  // 0x15 - символ "-1" поднятый
  0x00, 0x04, 0x04, 0x00, 0x2, 0x1f,


  // 0x16 - широкое подчеркивание.
  //0x00, 0x60, 0x60, 0x60, 0x60, 0x00,
  // 0x16 - полоса прокрутки заполненный низ закрытый верх
  //0xff, 0xf1, 0xf1, 0xff, 0x00, 0x00,
  // 0x16 - символ "-2" поднятый
  0x00, 0x04, 0x04, 0x19, 0x15, 0x13,

  // 0x17 - тонкая стрелка вверх-вниз с подчеркиванием.
  //0x00, 0x14, 0xb6, 0xff, 0xb6, 0x14,
  // 0x17 - полоса прокрутки заполненный низ открытый верх
0xff, 0xf0, 0xf0, 0xff, 0x00, 0x00,

  // 0x18 - тонкая стрелка вверх.
  //0x00, 0x04, 0x06, 0x7f, 0x06, 0x04,
  // 0x18 - полоса прокрутки заполненный верх закрытый низ
0xff, 0x8f, 0x8f, 0xff, 0x00, 0x00,

  // 0x19 - тонкая стрелка вниз.
  //0x00, 0x10, 0x30, 0x7f, 0x30, 0x10,
  // 0x19 - полоса прокрутки верх пустая инверсия
0x00, 0xfe, 0xfe, 0x00, 0xff, 0xff,

  // 0x1a - тонкая стрелка вправо.
  0x00, 0x08, 0x08, 0x3e, 0x1c, 0x08,
  // 0x1a - полоса прокрутки середина пустая инверсия
  //  0x00, 0xff, 0xff, 0x00, 0xff, 0xff,

  // 0x1b - тонкая стрелка влево.
  0x00, 0x08, 0x1c, 0x3e, 0x08, 0x08,
  // 0x1b - полоса прокрутки низ пустая инверсия
    //0x00, 0x7f, 0x7f, 0x00, 0xff, 0xff,

  // 0x1c - символ отступа.
  //0x00, 0x78, 0x40, 0x40, 0x40, 0x40,
  // 0x1c - полоса прокрутки заполненный верх открытый низ инверсия
0x00, 0xe0, 0xe0, 0x00, 0xff, 0xff,

  // 0x1d - тонкая стрелка влево-вправо.
  //0x00, 0x08, 0x3e, 0x08, 0x3e, 0x08,
  // 0x1d - полоса прокрутки заполненный низ закрытый верх инверсия
0x00, 0x0e, 0x0e, 0x00, 0xff, 0xff,

  // 0x1e - толстая стрелка вверх.
  //0x00, 0x30, 0x3c, 0x3f, 0x3c, 0x30,
  // 0x1e - полоса прокрутки заполненный низ открытый верх инверсия
0x00, 0x0f, 0x0f, 0x00, 0xff, 0xff,

  // 0x1f - толстая стрелка вниз.
  //0x00, 0x03, 0x0f, 0x3f, 0x0f, 0x03,
  // 0x1f - полоса прокрутки заполненный верх закрытый низ инверсия
0x00, 0x70, 0x70, 0x00, 0xff, 0xff,
