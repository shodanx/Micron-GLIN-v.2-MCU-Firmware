...
const  char lcd_font_table[0x01E0] = {
  ...
  0x1C, 0x2C, 0x40, 0x22, 0x1C, // 27 ' (заменен на символ v)
  ...
  0x06, 0x09, 0x09, 0x06, 0x00, // 5c Celsius
...
const  char lcd_font_table_rus[0x0140] = {
