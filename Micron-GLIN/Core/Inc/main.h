...
#define Control_bus_0_GPIO_Port GPIOA
#define Control_bus_1_Pin GPIO_PIN_1
#define Control_bus_1_GPIO_Port GPIOA
#define Control_bus_2_Pin GPIO_PIN_2
#define Control_bus_2_GPIO_Port GPIOA
#define Control_bus_3_Pin GPIO_PIN_3
#define Control_bus_3_GPIO_Port GPIOA
...
#define Display_DB4_Pin GPIO_PIN_2
#define Display_DB4_GPIO_Port GPIOB
...
#define Display_DB5_Pin GPIO_PIN_3
#define Display_DB5_GPIO_Port GPIOB
#define Display_DB6_Pin GPIO_PIN_4
